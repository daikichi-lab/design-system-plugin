...
| **素材 / material** | the actual copy & numbers | the deck content | ASK for the data; never fabricate figures |
...
| **構成 / structure** | pattern order & count | deck-strategy §2–4 | default: "おまかせ" (let deck-strategy frame it) |
